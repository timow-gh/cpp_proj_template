...
function(create_cppcheck_target)
    ...
    add_custom_target(cppcheck_target ALL
            COMMAND "${CPPCHECK_PROGRAM_PATH};--project=${CMAKE_BINARY_DIR}/compile_commands.json;--enable=all;--inconclusive;--std=c++${CMAKE_CXX_STANDARD};--suppress=*:*/cpp_proj_template/benchmark/benchmark_example_library.cpp;--suppress=*:*/unixlike-clang-debug/_deps/*;--suppress=*:*/fmt/*;--suppress=*:*/googlemock/*;--suppress=*:*/googletest/*;--suppress=*:*/date-*;--suppress=unmatchedSuppression;--suppress=missingIncludeSystem;--error-exitcode=10"
